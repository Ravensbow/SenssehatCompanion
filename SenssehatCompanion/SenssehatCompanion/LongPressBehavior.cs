...
namespace App.Controls.Behaviors
{
    public class LongPressBehavior : Behavior<Button>
    {
        ...
        public static readonly BindableProperty ObiektProperty =
           BindableProperty.Create(nameof(Obiekt), typeof(object), typeof(LongPressBehavior));
        ...
        {
            get => GetValue(ObiektProperty);
            set => SetValue(ObiektProperty, value);
        }
